...
if __name__ == "__main__":
    video_path = "C:/Users/harry/Projects/art-os/public/assets/video/blackout/bg-vid_4.mp4"  # Replace with the actual path of your input video
    output_path = "C:/Users/harry/Videos/Blackout/formatted"  # Replace with the desired output video path
